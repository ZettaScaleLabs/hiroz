// crates/hiroz-go/examples/subscriber_channel/main.go
//
...
func main() {
	log.Println("Starting hiroz Go channel-based subscriber example...")
	log.Println()
	...
	fifoHandler := hiroz.NewFifoChannel[[]byte](10)
	...
	ringHandler := hiroz.NewRingChannel[[]byte](3)
