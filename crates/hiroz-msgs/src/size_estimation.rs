...
//! are automatically generated by hiroz-codegen for all message types with dynamic
...
///
/// This is automatically implemented by hiroz-codegen for all message types with
